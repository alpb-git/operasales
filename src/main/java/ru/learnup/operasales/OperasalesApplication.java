...
public class OperasalesApplication {
    ...
    /**
     * Добавлено два асинхронных шедулера с разным временным интервалом:
     * Один пытается вставить запись каждую секунду и засыпает на 2 секунды
     * Другой пытается удалить запись каждые 3 секунды
     * Шедулеры не блокируют друг друга
     *
     * Мониторинг состояния БД H2
